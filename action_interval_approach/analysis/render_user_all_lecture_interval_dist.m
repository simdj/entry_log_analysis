function render_user_all_lecture_interval_dist(raw_data, query_user_number)
...
user_all_lecture_interval_dist = [ sum(query_user_data(:,3:end),1)];


render_interval_dist(user_all_lecture_interval_dist, strcat('user',int2str(query_user_number)));
