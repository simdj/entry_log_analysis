...
def generate_csv(mongo_csv, action_stat_file):

    # 1.start generating action.csv
    action_stat_file_file= open(action_stat_file, 'w')
    writer = csv.writer(action_stat_file_file, delimiter=",",lineterminator='\n')
    # writing header
...
if __name__ == "__main__":
    mongo_result_file='mongo_result_simple_action_snippet.csv'
    action_stat_file='simple_action_snippet.csv'
    generate_csv(mongo_result_file, action_stat_file);